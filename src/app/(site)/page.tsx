...
{cta&&<section className="dark-grid bg-red-700 py-20 text-white"><div className="container-shell flex flex-col justify-between gap-9 lg:flex-row lg:items-end"><div className="max-w-4xl"><h2 className="section-heading mt-4 text-balance">{cta.title}</h2><p className="section-description mt-5 text-red-100">{cta.subtitle}</p></div><Link href="/request-a-quote" className="btn-light shrink-0">Request a Quote <ArrowRight size={17}/></Link></div></section>}
</main>}
